...
public class H264StreamEncoder extends OneToOneEncoder {
    ...
    protected final IStreamCoder iStreamCoder;
    ...
    public H264StreamEncoder(Dimension dimension, boolean usingInternalFrameEncoder) {
        super();
        this.iStreamCoder = IStreamCoder.make(Direction.ENCODING);
    ...
    public synchronized Object encode(Object msg) throws Exception {
        if (msg == null) {
            return null;
        }
