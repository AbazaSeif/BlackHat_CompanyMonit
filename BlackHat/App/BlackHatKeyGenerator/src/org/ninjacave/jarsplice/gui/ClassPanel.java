  ...
  implements ActionListener
{
  ...
  protected JPanel getVmArgBox() {
    JPanel vmArgBoxLocal = new JPanel();
    vmArgBoxLocal.setLayout(new BorderLayout(5, 5));
    TitledBorder border2 = BorderFactory.createTitledBorder("Set VM Arguments");
    vmArgBoxLocal.setBorder(border2);
    ...
    vmArgBoxLocal.add(centerPanel3, "First");
    ...
    vmArgBoxLocal.add(centerVmArgPanel, "Center");

    return vmArgBoxLocal;
  }
