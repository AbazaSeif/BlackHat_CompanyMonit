...
public class FrameDecoder{
	...
	protected ChannelBuffer dataSink = ChannelBuffers.dynamicBuffer(131072, new HeapChannelBufferFactory());
	...
	public synchronized ChannelBuffer decode(ChannelBuffer channelBuffer) throws Exception {
