...
//    protected final static Logger logger = LoggerFactory.getLogger(H264StreamDecoder.class);
    protected final IStreamCoder iStreamCoder = IStreamCoder.make(Direction.DECODING);
    ...
    public H264StreamDecoder(StreamFrameListener streamFrameListener,
        ...
        this.iStreamCoder.setCodec(ICodec.ID.CODEC_ID_H264);
    ...
    @Override
    protected synchronized Object decode(ChannelHandlerContext ctx, Channel channel, final Object msg) throws Exception {
