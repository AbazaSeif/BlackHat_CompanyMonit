...
public class ERFPacketHeader
{
	...
	public ERFPacketHeader readNextHeader(FileInputStream in) throws IOException
	{
		...
		myRlen = ByteUtils.getByteNetOrderTo_uint16(data, 10);
		myLctr = ByteUtils.getByteNetOrderTo_uint16(data, 12);
		myWlen = ByteUtils.getByteNetOrderTo_uint16(data, 14);

		myPktPad = ByteUtils.getByteNetOrderTo_uint16(data, 16);
