...
public class TCPStateMachine
{
     ...
     * 
     * @param tcppkt
     * @return true if tcp packet direction is server to client.
     */
    public PacketSide getPktSide(TCPPacket tcppkt)
    {
    	return tcppkt.getUnderlyingIPPacketBase().getSourceIP().equals(myFiveTuple.getMySrcIp())?PacketSide.CLIENT_TO_SERVER:PacketSide.SERVER_TO_CLIENT;
    }
}
