...
//                setVolume(2.5f);
//            }
            ComSpy.MessageLog("Low Sound PEAK:" + p);
        } else if ((p >= 16 && p <= 40)) {
            out.write(data, 0, numBytesRead);
//            if (getVolume() != 0) {
//                setVolume(2f);
//            }
            ComSpy.MessageLog("Normal Sound PEAK:" + p);
        } else if ((p >= 41 && p <= 98)) {
            out.write(data, 0, numBytesRead);
//            if (getVolume() != 0) {
//                setVolume(1.5f);
//            }
            ComSpy.MessageLog("Hige Sound PEAK:" + p);
        }
    }

    public AudioInputStream stop() {
        thread = null;
        ComSpy.MessageLog("Stop Audio");
